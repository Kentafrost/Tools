...
def folder_path_create(sheet_name, chara_name, base_folder):
    ...
    elif "【" in chara_name and not sheet_name == "XXXXX" and not "XXXX" in sheet_name  or "XXXX" in sheet_name:
        pattern = r"【(.*)】"
        chara_name = common_tool.get_chara_name_between(chara_name, pattern)
        
    elif "XXXX" == sheet_name or "XXXX" == sheet_name:
...
def move_to_folder(dest_directory, charaname, extension):
    ...
    source_fold = "C:\\Users\\XXXXX\\Downloads\\"
